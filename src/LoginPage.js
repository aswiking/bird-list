    ...
    <div className="loginpage">
      ...
      <div className="body">
        ...
        <p className="login-options-title">Log in or sign up</p>
          <a
            href={`https://api.instagram.com/oauth/authorize?client_id=1440877326102459&redirect_uri=${(process.env.NODE_ENV === 'production') ? encodeURI('https://aswiking-fledgling.netlify.app/') : 'https://localhost:3000'}/&scope=user_profile,user_media&response_type=code`}
          >
